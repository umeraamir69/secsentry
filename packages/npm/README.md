...
> **This npm package is a PATH wrapper.** The detectors live in the Go binary. `npx secsentry` / `npm install -g secsentry` gives you a Node launcher; that launcher still needs the Go CLI on `PATH`.
...
- PyPI wrapper: [pypi.org/project/secsentry](https://pypi.org/project/secsentry/)
