...
ROTATION = {
    ...
    "square_token": "developer.squareup.com → your app → revoke the access token. Square handles payments; treat as urgent.",
    ...
    "sendgrid_key": "app.sendgrid.com → Settings → API Keys → delete. Check mail send logs.",
    "twilio_key": "console.twilio.com → API keys → delete. Review usage for fraud.",
    "npm_token": "npmjs.com → Access Tokens → revoke. Republish nothing until rotated.",
